                  ...
                  child: Container(
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Positioned(left: 12, top: 56,
                          child: Text(S.of(context).globalQuote, style: TextStyle(color: Colours.light_red_text, fontSize: 14, fontWeight: FontWeight.w600, height: 1.0)),
                        ),
                      ],
                    ),
                  )
                  ...
                  child: Container(
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Positioned(left: 12, top: 56,
                          child: Text(S.of(context).treemap, style: TextStyle(color: Colours.light_blue_text, fontSize: 14, fontWeight: FontWeight.w600, height: 1.0)),
                        )
                      ],
                    ),
                  )
