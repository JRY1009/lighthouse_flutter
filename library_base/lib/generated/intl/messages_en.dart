...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(param) => "已成为灯塔塔民${param}天";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "notSetPassword" : MessageLookupByLibrary.simpleMessage("该账户未设置登录密码\n可使用短信验证码登录"),
    "notSetPasswordTips" : MessageLookupByLibrary.simpleMessage("（登录后可在账户与安全中设置密码）"),
    ...
    "proLinkedExchangeCount" : MessageLookupByLibrary.simpleMessage("已接入交易所"),
    ...
    "shareArticle" : MessageLookupByLibrary.simpleMessage("我在区块灯塔发现一篇好文，一起来看："),
